    ...
    */
    ...
    // Interactive functionality --------------------------------------------------
      ...
      $('#data-view').change(function(){
       ...
       //     $('.year-main label').text('Three-year average:');
        //   $('.year-main label').text('to:');
        }else{
          $('.hide-if-trend').slideUp('slow');
          $('.year-start').animate({width:'0%'},400);
     //     $('.year-main label').text('3-year average:');
      ...
      $('#dl-table').on('click', function() {
       ...
       // var SE_test  =  array_column_conditional(seCols, 0, 0);
        ...
        var seCaption = "Standard errors for " +
          fullCaption3.charAt(0).toLowerCase() + fullCaption3.slice(1);
        ...
        var csv = $.grep(
          ['"'+fullCaption3.replace(" (standard errors)","")+'"', coefCSV,
...
//          '2018Q1', '2018Q2', '2018Q3', '2018Q4'],  title: 'Year'} : {};
      ...
      if(plotTraces === null) {
        ...
        var pltSource = newSource2.replaceAll('<b>','').replaceAll('</b>','');
    ...
    // Caption, Citation, Notes ---------------------------------------------------
      var fullCaption, fullCaption2, fullCaption3, plotCaption, newSource, newSource2, statName2;
    ...
    $(document).on('updateNotes', function() {
      ...
      $(document).on('updateNotes', function () {
          ...
          fullCaption = newCaption;
          fullCaption3 = fullCaption.replace(/\u2014|\u2014/g, "-");
//          fullCaption = newCaption + ", " + yearName;
          ...
          //this is new part
 //         fullTitle = qtitle + ", " + yearName;
          //var myJSON = JSON.stringify(qtitle);
          //var obj = JSON.parse(qtitle);


          //this is new part
 //         var titleCaption = showSEs ? fullTitle :
 //             fullTitle.replace(" (95% confidence intervals)", "");
 //         $('#table-title').text(qtitle);
