...
//          '2018Q1', '2018Q2', '2018Q3', '2018Q4'],  title: 'Year'} : {};
 ...
 //         $('#table-title').text(qtitle);
         ...
         //     ". Generated interactively: " + today.toDateString() + ".";
          ...
          var newCitation = NCHS + ". " + tableCaption + ". " + NHIS +
              ". Generated interactively: " + today3 + " from https://wwwndev.cdc.gov/NHISDataQueryTool/SHS_2021_ADULT3YR/index.html";
...
//USE THIS FOR NEW TITLE
          ...
          //$('#plot-caption2').html(plotCaption2);
