...
function qtr_to_num(str) { 
 ...
 //       .replace(", Jul-Dec", ".5"); 
  //  str2=str
   // str2 = str.replace("July 2021-December 2022", "2021") 
  //  str2 = str.replace("July 2021-December 2022", "2021")   
  //   str2 = str.replace(", Jan-Jun", ".0") 
 // .replace(", Jul-Dec",".5");  
 ...
 function num_to_qtr(num) {  
   ...
   if(Number.isInteger(num)){  
     ...
     str2 = str.replace("2021", "2019-2021")
...
//function myFunction2() {
    ...
    //year = year.replace("2019-2021", "July 2021-December 2022")
//}
               ...
               if (arr && arr.length > 0) {
                   for (var i = 0; i < arr.length; i++) {
                       for (var j = 0; j < arr[i].length; j++) {
                           if (arr[i][j].startsWith("*")) test[i][j] = val
                           else test[i][j] = arr[i][j];
                       }
                       return test;
                   }
                   //console.log(contains(arr, "*"));
